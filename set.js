...
const botname = process.env.BOTNAME || '𝔻𝔸ℝ𝕂-𝔹𝕆𝕐';
const antibot = process.env.ANTIBOT || 'FALSE';
const author = process.env.STICKER_AUTHOR ||'<𝓓𝓪𝓻𝓴-𝓓𝓔𝓿 />';
const packname = process.env.STICKER_PACKNAME || '🍷';
const antitag = process.env.ANTITAG || 'TRUE';
const dev = process.env.DEV || '22603582906';
const menulink = process.env.MENU_LINK || 'https://files.catbox.moe/5o09h5.png';
const menu = process.env.MENU_TYPE || 'IMAGE';
const DevCrazy = dev.split(",");
